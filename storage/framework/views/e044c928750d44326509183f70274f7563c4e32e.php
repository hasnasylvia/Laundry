                ...
                <div class="row">
                    <div class="col-lg">
                        <div class="p-5">
                            ...
                            <form class="user" action="<?php echo e(route('register')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?php echo e(route('tampil_login')); ?>">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\laundry\resources\views/login/register.blade.php ENDPATH**/ ?>