    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <a href="<?php echo e(route('tampil-owner')); ?>" class="btn btn-secondary btn-sm float-right"><i class="fa fa-undo"></i>Back</a>
            </div>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('home.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laundry\resources\views/transaksi_crud/detail_owner.blade.php ENDPATH**/ ?>