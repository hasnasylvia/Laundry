                    ...
                    <div class="col-lg">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">いらっしゃいませ!</h1>
                            </div>
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="<?php echo e(route('register')); ?>">Dont have an account? Register!</a>
                            </div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\laundry\resources\views/login/login.blade.php ENDPATH**/ ?>